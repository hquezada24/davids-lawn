  ...
  return (
    <section id="services" className="max-w-6xl mx-auto px-8 py-24">
      ...
      <h2 className="font-serif text-5xl text-[#f5f0e8] tracking-tight leading-tight mb-12">
        Everything your
        <br />
        lawn <em className="text-[#a8d44b] not-italic">needs.</em>
      </h2>
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
        <div className="transition-[transform, border-color] duration-200 hover:border-[rgba(168,212,75,0.5)] hover:-translate-y-1 bg-[#243824] border border-[#a8d44b]/15 rounded-2xl p-7">
          <span className="text-3xl block mb-4">🌾</span>
          <h4 className="text-[#f5f0e8] font-medium text-lg mb-2">
            Lawn Mowing
          </h4>
          <p className="text-[#f5f0e8]/50 font-light text-sm leading-relaxed">
